          ...
          const upgradeResult = await resend.emails.send({
            ...
            html: `
              <div style="font-family: 'Hanken Grotesk', -apple-system, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 560px; margin: 0 auto; background-color: #f6f4ec; padding: 28px 24px; color: #1b241d; border: 1px solid #e7e1d3; border-radius: 14px;">
                ...
                ${input.message ? `<p style="padding: 12px 16px; background: #f2ede1; border-radius: 8px; border-left: 3px solid #2f6b43;"><em>"${input.message}"</em></p>` : ''}
                ...
                <p style="margin: 24px 0;">
                  <a href="${dashboardUrl}" style="display: inline-block; background: #2f6b43; color: #f3ecdc; padding: 12px 24px; border-radius: 13px; text-decoration: none; font-weight: 700;">
                    Go to Dashboard
                  </a>
                </p>
